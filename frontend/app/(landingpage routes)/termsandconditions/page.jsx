	...
	return (
		<div className="w-full flex flex-col justify-center items-center">
			...
			<div className="w-full min-h-[600px]">
				<div className="max-w-[1300px] sm:mx-auto mx-6 pb-[100px] sm:break-normal break-all">
					<h1 className="font-bold lg:text-4xl text-2xl text-[--blue] text-center py-20 ">
						TERMS AND CONDITIONS
					</h1>

					<div className="py-8">
						<h2 className="font-bold lg:text-2xl ">General Terms</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							By accessing and placing an order with Kyrus Recycling, you
							...
							communication between you and Kyrus Recycling.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Under no circumstances shall Kyrus Recycling team be liable for
							...
							this site, even if Kyrus Recycling team or an authorized
							representative has been advised of the possibility of such
							damages. If our use of materials from this site results in the
							need for servicing, repair or correction of equipment or data, you
							assume any costs thereof.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling will not be responsible for any outcome that may
					...
					<div className="py-8">
						<h2 className="font-bold lg:text-2xl mt-8">License</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling grants you a revocable, non-exclusive,
							non-transferable, limited license to use the website strictly in
							accordance with the terms of this Agreement.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							These Terms & Conditions are a contract between you and Kyrus Recycling (referred to in these Terms &
							Conditions as "Kyrus Recycling", "us", "we" or "our"), the
							provider of the Kyrus Recycling website and the services
							accessible from the Kyrus Recycling website (which are
							collectively referred to in these Terms & Conditions as the "Kyrus
							Recycling Service").
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							You are agreeing to be bound by these Terms & Conditions. If you
							do not agree to these Terms & Conditions, please do
							not use the Kyrus Recycling Service. In these Terms & Conditions, "you" refers both to
					...
					<div className="py-8">
						<h2 className="font-bold lg:text-2xl mt-8">
						...
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>Cookie</strong>
							: small amount of data generated by a website and saved by your web browser. It is used to
							identify your browser, provide analytics, remember information
							about you such as your language preference or login information.
						</li>

						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>Company</strong>
							: when this terms mention “Company,” “we,” “us,” or “our,” it refers to KYRUS RECYCLING
							VENTURES, (22, Ikhaladeran street, Ekehuan, Benin, Edo), that is
							responsible for your information under this Terms & Conditions.
						</li>

						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>Country</strong>: where Kyrus Recycling or the owners/
							<br className="hidden sm:block" />
							founders of Kyrus Recycling are based, in this case is Nigeria
						</li>
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>Device</strong>
							: any internet connected device such as a phone, tablet, computer or any other device that can
							be used to visit Kyrus Recycling and use the services.
						</li>
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>Service</strong>
							: refers to the service provided by Kyrus Recycling as described in the relative terms (if
						...
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							others who provide our content or whose products or services we
							think may interest you.
						</li>
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>Website</strong>: Kyrus Recycling’s site, which can be
							accessed via this
							<b></b>URL: kyrusrecycling.com
						</li>
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							<strong>You</strong>: a person or entity that is registered with
							Kyrus Recycling to use the Services.
						</li>
					</div>

					<div className="py-8">
						<h2 className="font-bold lg:text-2xl mt-8">Restrictions</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
						...
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							commercially exploit the website or make the platform available to
							any third party.
						</li>
						...
						<li className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							Kyrus Recycling or its affiliates, partners, suppliers or the
							licensors of the website.
						</li>
					</div>

					<div className="py-8">
						<h2 className="font-bold lg:text-2xl py-8">
							Return and Refund Policy
						</h2>
						<h2 className="font-semibold lg:text-2xl">Your Suggestions</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Any feedback, comments, ideas, improvements or suggestions (collectively, "Suggestions") provided by you
							to Kyrus Recycling with respect to the website shall remain the
							sole and exclusive property of Kyrus Recycling.
						</p>

						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose
							and in any way without any credit or any compensation to you.
						</p>

						<h2 className="font-semibold lg:text-2xl ">Your Consent</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							We've updated our Terms & Conditions to provide you with complete
							transparency into what is being set when you
							visit our site and how it's being used. By using our website, registering an account, or making a
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							Kyrus Recycling. We are not responsible for the content, accuracy
							...
							Services to another website, our Terms & Conditions are no longer
							...
							website’s own rules and policies. Such third parties may use their
							own cookies or other methods to collect information about you.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Cookies</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small
							...
							may become unavailable or you would be required to enter
							your login details every time you visit the website as we would
							not be able to remember that you had logged in previously. Most
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							You acknowledge and agree that Kyrus Recycling may stop
							(permanently or temporarily) providing the Service (or any
							features within the Service) to you or to users generally at Kyrus
							Recycling’s sole discretion, without prior notice to you. You may
							stop using the Service at any time. You do not need to
							specifically inform Kyrus Recycling when you stop using the
							Service. You acknowledge and agree that if Kyrus
							Recycling disables access to your account, you maybe prevented from accessing the Service, your account
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling reserves the right to modify, suspend or discontinue, temporarily or permanently, the
							website or any service to which it connects, with or without
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling may from time to time provide enhancements or
							improvements to the features/ functionality
							of the website, which may include patches, bug fixes, updates, upgrades and
							other modifications ("Updates").
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Updates may modify or delete certain features and/or functionalities of the website. You agree that Kyrus
							Recycling has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any particular
						...
						<h2 className="font-bold lg:text-2xl mt-8">Third-Party Services</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							We may display, include or make available third-party content (including data, information, applications and
							other products services) or provide links to third-party websites
							or services ("Third- Party Services").
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							You acknowledge and agree that Kyrus Recycling shall not be
							...
							or any other aspect thereof. Kyrus Recycling does not assume and
						...
						<h2 className="font-bold lg:text-2xl mt-8">Term and Termination</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							This Agreement shall remain in effect until terminated by you or
							Kyrus Recycling.
							<br />
							Kyrus Recycling may, in its sole discretion, at any time and for any or no reason, suspend or terminate this
							Agreement with or without prior notice.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							This Agreement will terminate immediately, without prior notice from Kyrus Recycling, in the event that you
							fail to
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Termination of this Agreement will not limit any of Kyrus Recycling's rights or remedies at law or in equity in
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							of the material that is claimed to be infringing; (c) your contact
							information, including your address, telephone
							number, and an email; (d) a statement by you that you have a good faith belief that use of the
							material is not authorized by the copyright owners; and (e) the
							a statement that the information in the notification is accurate,
							and, under penalty of perjury you are authorized to act on behalf
							of the owner.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Indemnification</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							You agree to indemnify and hold Kyrus Recycling and its parents, subsidiaries, affiliates, officers, employees,
							...
							out of your: (a) use of the website; (b) violation of this
							Agreement or any law or regulation; or (c) violation of any right
							of a third party.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">No Warranties</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							Kyrus Recycling, on its own behalf and on behalf of its affiliates
							and its and their respective licensors and service providers,
							expressly disclaims all warranties, whether
							express, implied, statutory or otherwise, with respect to the website, including all implied
							...
							Without limitation to the foregoing, Kyrus Recycling provides no
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Without limiting the foregoing, neither Kyrus Recycling nor any
							Kyrus Recycling's provider makes any representation or warranty of
							any kind, express or implied: (i) as to the operation or
							availability of the website, or the information,
							content, and materials or products included thereon; (ii) that the website will be
							...
							content, or e-mails sent from or on behalf of Kyrus Recycling are
							free of viruses, scripts, trojan horses, worms, malware, time
							bombs or other harmful components.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							liability of Kyrus Recycling and any of its suppliers under
							any provision of this Agreement and your exclusive remedy for all of the foregoing shall be
							limited to the amount actually paid by you for the website.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							To the maximum extent permitted by applicable law, in no event
							shall Kyrus Recycling or its suppliers be liable for any
							...
							connection with any provision of this Agreement), even if Kyrus
							Recycling or any supplier has been advised of the possibility of
						...
						<h2 className="font-bold lg:text-2xl mt-8">Severability</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							This Agreement, together with the Privacy Policy and any other legal notices published by Kyrus Recycling
							on the Services, shall constitute the entire agreement between you
							and Kyrus Recycling concerning the Services. If any provision of
							...
							this Agreement shall be deemed a further or continuing waiver of
							such term or any other term, and Kyrus Recycling’s failure to
							assert any right or provision under this Agreement shall not
							constitute a waiver of such right or provision. YOU AND Kyrus
							Recycling AGREE THAT ANY CAUSE OF ACTION ARISING OUTOF OR RELATED TO THE SERVICES
							MUST COMMENCE WITHIN ONE (1) YEAR AFTER THE CAUSE OF
							ACTION ACCRUES. OTHERWISE, SUCH CAUSE OF ACTION IS PERMANENTLY
							BARRED.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Waiver</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Except as provided herein, the failure to exercise a right or to require performance of an obligation under this
							Agreement shall not effect a party's ability to exercise such
							right or require such performance at any time thereafter nor shall
							be the waiver of a breach constitute waiver of any subsequent
							breach.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							No failure to exercise, and no delay in exercising, on the part of
							either party, any right or any power under
							thisAgreement shall operate as a waiver of that right or power. Nor shall any single or partial exercise of any
							right or power
							under this Agreement preclude further exercise of that or any other right granted herein. In
							the event of a conflict between this Agreement and any applicable
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							no longer authorized to use Kyrus Recycling.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Entire Agreement</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							The Agreement constitutes the entire agreement between you and Kyrus Recycling regarding your use of
							the website and supersedes all prior and contemporaneous written
							or oral agreements between you and Kyrus Recycling.
						</p>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							You may be subject to additional terms and conditions that apply when you use utilize other Kyrus
							Recycling's services, which Kyrus Recycling will provide to you at
							the time of such use or purchase.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Updates to Our Terms</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							We may change our Service and policies, and we may need to make
							changes to these Terms so that they accurately
							reflect our Service and policies. Unless otherwise required by law, we will notify you (for example,
							through our Service) before we make changes to these Terms and
						...
						<h2 className="font-semibold sm:text-[25px] mt-10">
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							arrangement thereof), are owned by Kyrus
							Recycling, its licensors or other providers of such material and are protected by Nigeria and
							international copyright, trademark, patent, trade secret and other
							intellectual property or proprietary rights
							laws. The material may not be
							copied, modified, reproduced, downloaded or distributed in any way, in whole
							or in part, without the express prior
							written permission of Kyrus Recycling, unless and except as is expressly
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR
							OR Kyrus Recycling’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute, action,
							or other controversy between you and Kyrus Recycling concerning
							the Services or this agreement, whether in contract, warranty,
							tort, statute, regulation, ordinance, or any other legal or
							equitable basis. “Dispute” will be given the broadest possible
							meaning allowable under law.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Notice of Dispute</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							In the event of a dispute, you or Kyrus Recycling must give the
							...
							<a href="mailto:kyrusrecycling@gmail.com" className="underline">
								kyrusrecycling@gmail.com
							</a>
							. Kyrus Recycling
							will send any Notice of Dispute to you by mail to your address if
							we have it, or otherwise to your email address. You and Kyrus
							Recycling will attempt to resolve any dispute
							through informal negotiation within sixty (60) days from the
							date the Notice of Dispute is sent. After sixty (60) days, you or
							Kyrus Recycling may commence arbitration.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Binding Arbitration</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							If you and Kyrus Recycling don’t resolve any dispute by informal
							negotiation, any other effort to resolve the dispute will
							be conducted exclusively by binding arbitration as described in this section. You are giving up the
							...
							arbitration rules applicable in Nigeria. Either party may seek any
							interim or preliminary injunctive relief from any
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							property of Kyrus Recycling without any
							compensation or credit to you
							whatsoever. Kyrus Recycling and its affiliates shall have no obligations with
						...
						<h2 className="font-bold lg:text-2xl mt-8">Promotions</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling may, from time to time, include contests,
						...
						<h2 className="font-bold lg:text-2xl mt-8">Typographical Errors</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							product and/or service listed at the incorrect
							price. We shall have the right to refuse or cancel any such order whether or
							...
							your order is canceled, we shall immediately issue a credit to
							your credit card account or other payment account in the amount of
							the charge.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Miscellaneous</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							...
							Kyrus Recycling. Kyrus Recycling will be entitled to injunctive or other equitable
							relief (without the obligations of
							posting any bond or surety) in the event of any breach or anticipatory
							breach by you. Kyrus Recycling operates and controls the Kyrus
							Recycling Service from its offices in Nigeria. The Service is not
							...
							choose to access the Kyrus Recycling Service from other locations
							...
							incorporate the Kyrus Recycling Privacy Policy) contains the
							entire understanding, and supersedes all prior understandings,
							between you and Kyrus Recycling concerning its
							subject matter, and cannot be changed or modified
							by you. The section headings used in this Agreement are for
							convenience only and will not be given any legal import.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Disclaimer</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							Kyrus Recycling is not responsible for any content, code or any other imprecision.
							Kyrus Recycling does not provide warranties or guarantees. In no
							event shall Kyrus Recycling be liable for any special, direct,
							...
							of or in connection with the use of the Service or the contents of
						...
						<p className="lg:text-xl leading-8 tracking-[0.5px] py-5">
							The Kyrus Recycling Service and its contents are provided "as is"
							and "as available" without any warranty or representations of any
							kind, whether express or implied. Kyrus Recycling is a distributor
							and not a publisher of the content supplied by third parties; as
							such, Kyrus Recycling exercises no editorial control over such
							content and makes no warranty or representation as to the
							accuracy, reliability or currency of any
							information, content, service or
							merchandise provided through or accessible via the Kyrus Recycling Service.
							Without limiting the foregoing, Kyrus Recycling specifically
							disclaims all warranties and representations in any content
							transmitted on or in connection with the Kyrus Recycling Service
							or on sites that may appear as links on the Kyrus Recycling
							Service, or in the products provided as a part of, or otherwise in
							connection with, the Kyrus Recycling Service, including without
							...
							oral advice or written information given by Kyrus Recycling or any
							...
							Kyrus Recycling does not warrant that the Kyrus Recycling Service will be uninterrupted, uncorrupted,
							timely, or error-free.
						</p>

						<h2 className="font-bold lg:text-2xl mt-8">Contact Us</h2>
						<p className="lg:text-xl leading-8 tracking-[0.5px] pb-5">
							Don't hesitate to contact us if you have any questions.
						</p>
						<div className="flex flex-col gap-3">
							<li className="lg:text-lg leading-8 tracking-[0.5px]">
								Email: 
								<a href="mailto:kyrusrecycling@gmail.com	">
									kyrusrecycling@gmail.com
								</a>
							</li>
							<li className="lg:text-lg leading-8 tracking-[0.5px] ">
								Phone Number: <a href="tel:+2348071926379">08071926379</a>
							</li>
							<li className="lg:text-lg leading-8 tracking-[0.5px] ">
								Website:
								<a href="http://kyrusrecycling.com" target="_blank">
									 kyrusrecycling.com
								</a>
							</li>
						</div>
